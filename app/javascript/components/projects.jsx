                ...
                <div className="mobile-projects">
                    <div className="mobile-projects-indv">
                        ...
                        <div className="mobile-projects-wordblock">
                            ...
                            <img className="logos1" src={GithubPages}/>
                        </div>
                    </div>
                    <div className="mobile-projects-indv">
                        <img src={goldFishTrainerds} alt="Portfolio Item" className="mobile-portfolio-image"/>
                        <div className="mobile-projects-wordblock">
                            <p className="mobile-wording-title">Goldfish Trainerds</p>
                            <a href='https://goldfish-trainerds.herokuapp.com/' className='goToAndGit'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-in">
                                <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path>
                                <polyline points="10 17 15 12 10 7"></polyline>
                            ...
                            <span>
                                <p className="mobile-wording">This is a Group Project. It is built on Ruby on Rails, with Postgres SQL as Database and hosted on Heroku. This is a Social media application for goldifsh lovers</p>
                                <img className="logos" src={Rails}/>&nbsp;
                                <img className="logos" src={Postgres}/>&nbsp;
                                <img className="logos" src={HerokuLogo}/>
                            </span>
                    ...
                    <div className="mobile-projects-indv">
                        <img src={Travinary} alt="Portfolio Item" className="mobile-portfolio-image"/>
                        <div className="mobile-projects-wordblock">
                        <p className="mobile-wording-title">Travinary</p>
                        <a href='https://travinary.herokuapp.com/' className='goToAndGit'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-in">
                            <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path>
                            <polyline points="10 17 15 12 10 7"></polyline>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
                            ...
                            <span>
                                <p className="mobile-wording">This is a Itinery Planning app for users to enter the country and location which they would like to visit.</p>
                                <img className="logos" src={Rails}/>&nbsp;
                                <img className="logos" src={Postgres}/>&nbsp;
                                <img className="logos" src={ReactIcon}/>&nbsp;
                                <img className="logos" src={HerokuLogo}/>
                    ...
                    <div className="mobile-projects-indv">
                        <img src={meetUpDrf} alt="Portfolio Item" className="mobile-portfolio-image"/>
                        <div className="mobile-projects-wordblock">
                        <p className="mobile-wording-title">Meetup DRF</p>
                        <a href='http://meetup-env.eba-ynfrzqwv.ap-southeast-1.elasticbeanstalk.com/api/meetups/' className='goToAndGit'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-in">
                            <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path>
                            <polyline points="10 17 15 12 10 7"></polyline>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
                            ...
                            <span>
                                <p className="mobile-wording">This is a backend API project. It is built on Python with Django on SQLite3 Database. It is meant to serve a React Front end</p>
                                <img className="logos1" src={ElasticLogo}/>&nbsp;
                                <img className="logos1" src={DjangoLogo}/>&nbsp;
                                <img className="logos1" src={SQLite3Logo}/>
                            </span>
                        </div>
                    </div>
                </div>
